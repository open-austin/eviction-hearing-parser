...
=======
    sched.add_job(scrape_filings_and_settings_task, 'interval', days=1, start_date='2020-11-08 04:55:00', timezone='US/Eastern')
>>>>>>> 660243051066ea313511141d3ea9a83fcc53f27b
    sched.start()
